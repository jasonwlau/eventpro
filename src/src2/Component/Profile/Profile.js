...
import { myStorage, myFirestore } from "../../../login/config/fire";
...
class Profile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      bio: localStorage.getItem(AppString.BIO),
      photoUrl: localStorage.getItem(AppString.PHOTO_URL),
      events: localStorage.getItem(AppString.EVENTS),
      friends: localStorage.getItem(AppString.FRIENDS),
    };
    this.newAvatar = null;
    this.newPhotoUrl = "";
  }
