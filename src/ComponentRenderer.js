...
import addUserToEvent from "components/forms/addUserToEvent";
...
export const components = {
  ...
  innerPages: {
    ...
    searchGroups:{
      ...
      url: '/components/innerPages/searchGroups',
      imageSrc: BlogIndexPageImageSrc,
    },
    SearchUsers: {
      component: SearchUsers,
      url: `/components/innerPages/SearchUsers`,
      imageSrc: BlogIndexPageImageSrc,
    },
    TermsOfServicePage: {
    ...
    Onboarding: {
      ...
      imageSrc: LoginPageImageSrc,
      url: "/components/innerPages/Onboarding",
    },
    Intro1: {
      component: Intro1,
      imageSrc: LoginPageImageSrc,
      url: "/components/innerPages/Intro1",
    },
    Intro2: {
      component: Intro2,
      imageSrc: LoginPageImageSrc,
      url: "/components/innerPages/Intro2",
    },
    Intro3: {
      component: Intro3,
      imageSrc: LoginPageImageSrc,
      url: "/components/innerPages/Intro3",
    },
    Deactivate: {
      component: Deactivate,
      url: "/components/innerPages/deactivate"
    },
    Meeting: {
      component: Meeting,
    ...
    Homepage: {
      component: Homepage,
      url: "/components/innerPages/Homepage",
    }
  },
    ...
    Cards: {
      ...
      elements: {
        ...
        Badges:{
          name:"Badges",
          component:Badges,
          url:"/components/blocks/Cards/Badges"
        },
        Portfolio: {
...
export default () => {
  ...
  try {
    ...
    else if (type === "innerPages" && name === "onboarding")
    {
      return <Onboarding />;
    }
    else if (type === "innerPages" && name === "deactivate")
    {
      return <Deactivate />;
    }
