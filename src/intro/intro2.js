...
import Video from "./Intro2Screen.mp4";
...
class Intro2 extends Component{
    ...
    buttonHandler = async (history) => {
        window.location.href = "/components/innerPages/Intro3";
      };


    render(){
        const subheading = "There is much you can do with ProEvento...";
        const heading = "Learn how to host virtual meetings!";
        const description = "You can connect with your friends anywhere in the world.";
        return(
          <Container>
          ...
          {description && <Description>{description}</Description>}
                ...
                {/* <video class="vjs-matrix video-js" Videojs {...videoJsOptions} /> */}
                <VideoJS />
