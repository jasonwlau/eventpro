...
import Video from "./Intro3Screen.mp4";
import VideoJS from "./video3.js";
...
class Intro3 extends Component
{
    buttonHandler = async (history) => {
      ...
      render(){
        const subheading = "You're almost ready to go!";
        const heading = "You can check invitation from your friends using the notification page and easily access live meetings!";
        const description = "You can find public/friends events using our search function.";
        return(
          <Container>
